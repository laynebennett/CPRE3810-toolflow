...
begin
	...
	s_haz <= ((s_reg_use_haz or s_load_use_haz) and (not(i_LUI_IFID or i_UJ_IFID)));-- and (not i_Store));

--PC write enables stall on hazard
o_PC_WEn <= '0' when ((s_haz = '1') and (i_EX_BranchTaken = '0'))  else '1';

--IF/ID wrte enable stall on hazard	
o_IFID_WEn <= '0' when ((s_haz = '1') and (i_EX_BranchTaken = '0')) else '1';
