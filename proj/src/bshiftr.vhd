...
begin
    ...
    gen_s0 : for i in 0 to 31 generate --shift bits depending on bit shift amount
    ...
    reverse_loop: for i in 0 to 31 generate --for right shifts
	sr(i) <= sd(31-i);
    end generate;


    o_d <= sd when (i_dir = '1') else sr; --select between left and right shift
